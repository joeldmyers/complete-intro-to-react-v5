...
## My notes on converting to Typescript:

run `npx tsc --init` to initialize the typescript project.

This creates a tsconfig file, but we have to modify.

Change target and preserve (see config file). strict = true. Harder but better.
